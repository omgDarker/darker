...
public class ImageHandler {
    ...
    public Map<String, Object> uploadImage(MultipartFile myImage) throws IOException {
        Map<String, Object> map = new HashMap<>();
        // 获取上传文件原始名称
        String oldImageName = myImage.getOriginalFilename();
        // 存储图片的虚拟本地路径
        String saveImagePath = "E://picture";
        // 上传图片
        if (myImage != null && oldImageName != null && oldImageName.length() > 0) {
            // 新图片名称
